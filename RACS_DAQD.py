...
REC_SIG = 'radio_rx  4D43433131387374617274' # 4d43433131387374617274 = "MCC118start"
SHUTDOWN_SIG = 'radio_rx  4D434331313873687574646F776E' # 4d434331313873687574646f776e = "MCC118shutdown"
PING_SIG = 'radio_rx  4D434331313850494E47' # 4d434331313850494e47 = "MCC118PING"
...
READY_RESPONSE = DAQ_NAME + ' is ready!'
...
TRIGG_RESPONSE = DAQ_NAME + ' has been triggered!'
TRIGG_HEX = binascii.hexlify(TRIGG_RESPONSE.encode()).decode()

# Response transmitted by radio when the trigger message has been
# received. **MUST STAGGER RESPONSES FROM MULTIPLE RADIOS
SHUTDOWN_RESPONSE = DAQ_NAME + ' is shutting down... Goodnight.'
